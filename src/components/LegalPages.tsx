      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm space-y-4 text-xs text-gray-600 leading-relaxed max-h-[60vh] overflow-y-auto">
        ...
        {activeTab === 'privacy' && (
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-gray-800">1. 個人情報・アカウント情報の取得と利用目的</h4>
              <p>
                当アプリは、基本的なフレーズ学習や機能の利用においてはユーザー登録やログイン不要でご利用いただけます。
              </p>
              <p>
                ただし、広告非表示プラン（買い切りサポーター機能）のご利用にあたり、購入情報の紐付けおよび複数端末間での復元を行うため、Firebase Authenticationを通じたアカウント登録・ログイン（Googleアカウント認証またはメールアドレス登録）を行っていただいております。
              </p>
              <p>
                取得したアカウント情報（ユーザー識別ID、メールアドレス等）は購入状態の管理およびユーザーサポートの目的でのみ使用し、第三者へ提供・販売することは一切ありません。なお、決済情報（クレジットカード番号等）は決済代行会社（Stripe）において厳重に管理され、当アプリのサーバー側で決済情報を保持・閲覧することはありません。
              </p>
            </div>
        ...
        {activeTab === 'terms' && (
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-gray-800">5. サービスの変更・中断・終了</h4>
              <p>
                制作者は、保守点検、システム障害、または開発・運営上のやむを得ない事情が発生した場合、ユーザーへの事前の通知または事前の周知（可能な場合）をもって、当アプリのサービス内容の変更、一時的な中断、または提供の終了を行うことができるものとします。
              </p>
              <p>
                当アプリの変更、中断、またはサービス終了によってユーザーまたは第三者に生じた損害や不利益について、制作者は一切の責任を負いかねますので、あらかじめご了承ください。
              </p>
            </div>

            <div className="space-y-3">
              <h4 className="font-bold text-gray-800">6. 規約の変更・準拠法</h4>
              <p>
        ...
        {activeTab === 'info' && (
          <div className="space-y-4">
            ...
            <div className="bg-amber-500/5 rounded-2xl border border-amber-500/15 p-4 space-y-2 mt-4">
              ...
              <p className="text-[11px] text-gray-600 leading-relaxed">
                画面右上にある<strong>「サポーター募集」</strong>ボタンより、いつでもコーヒー1杯分（480円※買い切り）から寄付をすることが可能です。サポーターになると、御礼として<strong>すべてのアプリ内広告（全画面・インフィード）が非表示</strong>になります。
              </p>
            </div>
